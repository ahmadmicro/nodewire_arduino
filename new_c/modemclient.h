...
class ModemClient: public NodeWire
{
    ...
    public:
        ...
        void modemSetup(){
          ...
          //mClient.setGPRSNetworkSettings(F("web.gprs.mtnnigeria.net"));
          mClient.setGPRSNetworkSettings(F("internet.ng.airtel.com"));
          //mClient.setGPRSNetworkSettings(F("gloflat"));
          //mClient.setGPRSNetworkSettings(F("etisalat"));
